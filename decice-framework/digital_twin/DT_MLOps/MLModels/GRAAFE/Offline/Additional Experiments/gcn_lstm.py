...
if __name__ == "__main__":
    ...
    for epoch in range(NUM_EPOCHS):
        loss = train_dataset.train(
            gnn_model=GNN_Model,
            lstm_model=LSTM_Model,
            gnn_optim=optimizer1,
            lstm_optim=optimizer2,
    ...
    reconstruction, ground_truths = test_dataset.eval_model(
        gnn_model=GNN_Model, lstm_model=LSTM_Model, loader=test_loader
    )
