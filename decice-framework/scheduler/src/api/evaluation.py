...
@evaluation_router.post("/start", status_code=status.HTTP_201_CREATED, dependencies=[Depends(verify_internal_traffic)])
...
async def list_evaluations(service: EvaluationService = Depends(get_evaluation_service)):
