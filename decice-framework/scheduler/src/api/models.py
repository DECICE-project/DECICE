...
async def swap_model(
    ...
    # 1. Construct the physical path based on config
    ...
    # 2. Tell the Singleton to reload
...
#     Trigger a Hot-Swap of the live inference engine to a specific model version.
#     """
#     success = scheduler.hot_swap_model(request.version_id)
#     if not success:
#         raise HTTPException(
#             status_code=404,
#             detail=f"Model {request.version_id} not found or failed to load."
#         )
...
# ):
#     """Return the ID of the currently loaded model."""
#     return {"current_version": scheduler.current_model_version}
