...
from repositories.evaluation_repository import EvaluationJobRepository, get_evaluation_repository
...
class EvaluationService:
    ...
    async def start_evaluation(self, scheduler_name: str, dataset_name: str) -> EvaluationJob:
        # Validate Dataset
