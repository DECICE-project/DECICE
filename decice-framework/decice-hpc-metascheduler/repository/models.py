...
class Job(Base):
    ...
    status = Column(SQLAlchemyEnum(JobStateEnum), nullable=False, default=JobStateEnum.PENDING)
    ...
    last_update_timestamp = Column(DateTime, nullable=False, server_default=func.now(), onupdate=func.now())
